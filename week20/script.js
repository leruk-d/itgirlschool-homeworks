...
let json = `[{
    ...
    "moreDetails":"как и Росомаха из Людей Икс, Дэдпул был подвергнут опытам по программе «Оружие Икс». Ученые попытались исцелить его рак, привив его клеткам способность к регенерации. Как и всегда в комиксах, что-то пошло не так, и Дэдпул остался изуродованным и психически нестабильным.
...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    <div>Вселенная: ${hero.alterEgo}</div>
    <div>Вселенная:${hero.activity} </div>
    <div>Вселенная:${hero.friends} </div>
    <div>Вселенная: ${hero.superPowers}</div>
    <img class="img" alt="picture" src='${hero.picture}'>
    <div>Вселенная: ${hero.moreDetails}</div>
    </div>`
    }
